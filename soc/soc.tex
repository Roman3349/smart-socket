...
\begin{itemize}
	...
	\item komunikovat s~periferiemi přes sběrnice SPI, U(S)ART, I2C,
...
\centering
\label{fig:foto/rpi2}
\includegraphics[width = 128mm]{img/iqrf/os-blokove-schema.png}
...
Konfigurační soubor softwaru brány je psán v~datovém formátu YAML. A níže naleznete ukázkový konfigurační soubor.
