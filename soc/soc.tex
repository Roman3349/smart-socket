...
\begin{itemize}
	% Řádkování 1,5
	\renewcommand{\baselinestretch}{1.5}
	\item čtyřjádrový ARM\index[zkr]{ARM!Acorn RISC Machine|textit}\index[zkr]{ARM!Advanced RISC Machine|textit} Cortex-A7 Broadcom BCM2836, který pracuje na frekvenci 900~MHz,
	...
	\item microSD slot,
	\item HDMI výstup,
	\item 40 GPIO\index[zkr]{GPIO!General-purpose input/output|textit} pinů,
	\item sběrnice SPI\index[zkr]{SPI!Serial Peripheral Interface|textit}, I2C\index[zkr]{I2C!Inter-Integrated Circuit|textit}, USART\index[zkr]{USART!Universal Synchronous / Asynchronous Receiver and Transmitter|textit}.
\end{itemize}
